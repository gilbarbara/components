...
export type { HeadingLargeProps, HeadingProps } from '../components/Headings/useHeading';
...
export type { SearchItem, SearchProps } from '../components/Search/Search';
...
export type { TabProps, TabsProps } from '../components/Tabs/useTabs';
